...
func (x *fileServiceDownloadClient) Recv() (*DonwloadResponse, error) {
	m := new(DonwloadResponse)
...
func (x *fileServiceDownloadServer) Send(m *DonwloadResponse) error {
